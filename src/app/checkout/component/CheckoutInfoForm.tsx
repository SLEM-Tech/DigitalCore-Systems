			...
			<FormikProvider value={formik}>
				<Form className='max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8'>
					...
					<div className='lg:col-span-8 space-y-6'>
						<div className='bg-white rounded-xl p-6 sm:p-10 lg:shadow-sm lg:border border-gray-100'>
							...
							<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
								...
								<div className='md:col-span-2 space-y-2'>
									...
									<Field
										...
										className='w-full bg-gray-50 border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-primary-500/20 text-black transition-all outline-none'
									/>
									<ErrorMessage
										name='email'
										component='div'
								...
								<div className='md:col-span-2 space-y-2'>
									...
									<Field
										...
										className='w-full bg-gray-50 text-black border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-primary-500/20 transition-all outline-none'
									/>
									<ErrorMessage
										name='houseAddress'
										component='div'
								...
								<div className='space-y-1'>
									...
									<Field
										name='phone'
										className={`w-full border text-black p-4 rounded-xl text-sm focus:ring-2 outline-none transition-all ${
											formik.touched.phone && formik.errors.phone
												? "border-red-500 focus:ring-red-100"
												: "border-slate-200 focus:ring-primary-500/20"
										}`}
									/>
									{formik.touched.phone && formik.errors.phone && (
								...
								<div className='md:col-span-2 space-y-2'>
									...
									<Field
										...
										className='w-full text-black bg-gray-50 border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-primaryColor-100/20 transition-all outline-none resize-none'
									/>
								</div>
							</div>
						</div>
										...
										{[
											...
											<RadioGroup.Option
												...
												className={({ checked }) => `
                                                    ...
                                                    ${checked ? "border-primary-500 bg-primar-100/5" : "border-gray-100 hover:border-gray-200 bg-white"}
                                                `}
											>
												{({ checked }) => (
													<div className='flex w-full items-center justify-between'>
														...
														<RiWallet3Line
															className={
																checked ? "text-primary-500" : "text-gray-200"
															}
															size={20}
														/>
													</div>
